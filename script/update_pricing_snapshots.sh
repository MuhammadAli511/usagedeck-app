...
#
#   Sources/UsageDeck/Resources/pricing_litellm_snapshot.json      (LiteLLM model_prices)
#   Sources/UsageDeck/Resources/pricing_models_dev_snapshot.json   (models.dev api.json)
#
...
cd "$(dirname "$0")/.."
RESOURCES="Sources/UsageDeck/Resources"
