...
`/Users/admin/usagedeck-qa/20260913/UsageDeck.app`. Its executable SHA-256 matches the host build:
...
The updated debug app was built, copied to `/Users/admin/usagedeck-qa/UsageDeck.app`, and launched
...
The default was switched from work to personal, then back to work. UsageDeck's bundled CLI
...
The bundled UsageDeck CLI was launched from GUI Terminal through cua-driver and forced a refresh
...
resolved session creation. UsageDeck also initially waited in a Desktop Safe Storage Keychain read,
