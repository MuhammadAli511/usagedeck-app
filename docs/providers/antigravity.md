...
- **"Couldn't read Antigravity credentials…"** — unlock Keychain or sign in to Antigravity again. UsageDeck will not use its cached access token until the current login can be verified.
