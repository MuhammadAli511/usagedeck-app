...
final class SettingsMigratorTests: XCTestCase {
    ...
    func testV3RemapsDeadMenuBarPins() {
        ...
        defaults.set(
            ...
            forKey: "usagedeck.layout.v1.menuBarPins"
        )
        ...
        XCTAssertEqual(result, SettingsSchema.current)
        XCTAssertEqual(
            defaults.stringArray(forKey: "usagedeck.layout.v1.menuBarPins"),
    ...
    func testV3LeavesAlreadyCorrectPinsUnchanged() {
        ...
        defaults.set(pins, forKey: "usagedeck.layout.v1.menuBarPins")

        SettingsMigrator.migrate(defaults: defaults, domainName: domain)

        XCTAssertEqual(defaults.stringArray(forKey: "usagedeck.layout.v1.menuBarPins"), pins)
    }
    ...
    func testV3RemapsMetricIDsAcrossLayoutKeys() throws {
        ...
        defer { defaults.removePersistentDomain(forName: domain) }
        defaults.set(2, forKey: SettingsMigrator.schemaVersionKey)
        defaults.set(["antigravity.session", "copilot.credits"], forKey: "usagedeck.layout.v1.expandedMetrics")
        defaults.set(["antigravity.weekly"], forKey: "usagedeck.layout.v1.expandOnEnable")
        defaults.set(
            try JSONEncoder().encode(["antigravity.session", "claude.session"]),
            forKey: "usagedeck.layout.v1.seededDefaults"
        )
        defaults.set(
            ...
            forKey: "usagedeck.layout.v1.metricOrderByProvider"
        )
        let placed = [
        ...
        defaults.set(try JSONEncoder().encode(placed), forKey: "usagedeck.layout.v1")

        SettingsMigrator.migrate(defaults: defaults, domainName: domain)

        XCTAssertEqual(
            defaults.stringArray(forKey: "usagedeck.layout.v1.expandedMetrics"),
            ["antigravity.geminiPro", "copilot.premium"]
        )
        XCTAssertEqual(
            defaults.stringArray(forKey: "usagedeck.layout.v1.expandOnEnable"),
            ["antigravity.geminiWeekly"]
        )
        XCTAssertEqual(
            try JSONDecoder().decode([String].self, from: try XCTUnwrap(defaults.data(forKey: "usagedeck.layout.v1.seededDefaults"))),
            ["antigravity.geminiPro", "claude.session"]
        )
        XCTAssertEqual(
            try JSONDecoder().decode([String: [String]].self, from: try XCTUnwrap(defaults.data(forKey: "usagedeck.layout.v1.metricOrderByProvider"))),
            [
        ...
        let remappedPlaced = try JSONDecoder().decode(
            [PlacedWidget].self, from: try XCTUnwrap(defaults.data(forKey: "usagedeck.layout.v1"))
        )
    ...
    func testV3IsIdempotent() {
        ...
        SettingsMigrator.migrate(defaults: defaults, domainName: domain)
        let pinsAfterFirst = defaults.stringArray(forKey: "usagedeck.layout.v1.menuBarPins")
        defaults.set(2, forKey: SettingsMigrator.schemaVersionKey)
        SettingsMigrator.migrate(defaults: defaults, domainName: domain)

        XCTAssertEqual(defaults.stringArray(forKey: "usagedeck.layout.v1.menuBarPins"), pinsAfterFirst)
