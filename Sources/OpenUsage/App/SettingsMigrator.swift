...
enum SettingsSchema {
    ...
    static let migrations: [SettingsMigration] = [
        ...
        SettingsMigration(version: 3) { defaults in
            remapStringArrayMetricIDs(defaults, key: "usagedeck.layout.v1.menuBarPins")
            remapStringArrayMetricIDs(defaults, key: "usagedeck.layout.v1.expandedMetrics")
            remapStringArrayMetricIDs(defaults, key: "usagedeck.layout.v1.expandOnEnable")
            remapJSONMetricIDArray(defaults, key: "usagedeck.layout.v1.seededDefaults")
            remapJSONMetricOrder(defaults, key: "usagedeck.layout.v1.metricOrderByProvider")
            remapJSONPlacedWidgets(defaults, key: "usagedeck.layout.v1")
        }
    ]
