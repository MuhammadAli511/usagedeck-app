...
final class LogFile: @unchecked Sendable {
    ...
    static let shared = LogFile(directory: defaultDirectory(), fileName: "UsageDeck.log")
    ...
    private let fallbackLogger = Logger(subsystem: "UsageDeck", category: "logfile")
    ...
    static func defaultDirectory() -> URL {
        ...
        return library.appendingPathComponent("Logs/UsageDeck", isDirectory: true)
    }
