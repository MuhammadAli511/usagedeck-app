...
enum ClaudeAuthError: Error, LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .swapTokenExpired:
            return "Claude Swap login is stale. Launch this account with `cswap run`, then refresh UsageDeck."
        case .desktopTokenExpired:
            return "Claude Desktop login is stale. Open Claude Desktop, then refresh UsageDeck."
        case .desktopCredentialsUnavailable:
